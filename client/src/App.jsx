...
import { Search, Sparkles, ExternalLink, Bot, Code, Image as ImageIcon, PenTool, Video, Globe } from 'lucide-react'
        ...
        <div className="max-w-5xl mx-auto px-4 py-4">
          ...
          <div className="flex flex-col items-center justify-center text-center space-y-4 pb-2">
            ...
            <form onSubmit={handleSearch} className="w-full max-w-2xl relative group mt-4">
              ...
              <input
                type="text"
                className="block w-full pl-11 pr-4 py-4 bg-slate-100 border-transparent text-slate-900 placeholder-slate-400 rounded-xl focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 focus:outline-none transition-all shadow-sm"
              ...
              <div className="absolute inset-y-0 right-2 flex items-center">
                <button
                  type="submit"
                  disabled={loading}
                  className="p-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 transition-all"
                >
                  {loading ? (
